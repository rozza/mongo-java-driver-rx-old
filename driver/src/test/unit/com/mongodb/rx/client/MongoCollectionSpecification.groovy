...
class MongoCollectionSpecification extends Specification {
    ...
    def 'should create DistinctPublisher correctly'() {
        ...
        then:
        expect distinctPublisher, isTheSameAs(new DistinctObservableImpl(wrapped.distinct('field', String)))
    }
    ...
    def 'should create FindPublisher correctly'() {
        ...
        then:
        expect findPublisher, isTheSameAs(new FindObservableImpl(wrappedResult))
    ...
    def 'should use AggregatePublisher correctly'() {
        ...
        then:
        expect aggregatePublisher, isTheSameAs(new AggregateObservableImpl(wrappedResult))
    ...
    def 'should create MapReducePublisher correctly'() {
        ...
        then:
        expect mapReducePublisher, isTheSameAs(new MapReduceObservableImpl(wrappedResult))
    ...
    def 'should use the underlying listIndexes'() {
        ...
        then:
        expect publisher, isTheSameAs(new ListIndexesObservableImpl(wrapped.listIndexes(Document)))

        when:
        mongoCollection.listIndexes(BsonDocument)

        then:
        expect publisher, isTheSameAs(new ListIndexesObservableImpl(wrapped.listIndexes(BsonDocument)))
    }
